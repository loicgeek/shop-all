...
class Model{
    ...
    public function __construct($table_name=null){
        ...
        if(isset($table_name))
            $this->table_name = $GLOBALS['config']['prefix'] . $table_name;
        else $this->table_name = $GLOBALS['config']['prefix'] . $this->table_name;
    ...
    public function insert($list){
        ...
        $sql = "INSERT INTO `{$this->table_name}` ({$field_list}) VALUES ($value_list)";
    ...
    public function update($list){
        ...
        $sql = "UPDATE `{$this->table_name}` SET {$uplist} WHERE {$where}";



        if ($rows=$this->db->query($sql)->rowCount()) {
    ...
    public function selectByPk($pk){
        ...
        $sql = "select * from `{$this->table_name}` where `{$this->fields['pk']}`=$pk";
    ...
    /*
     * Return all data from the model table
     */
